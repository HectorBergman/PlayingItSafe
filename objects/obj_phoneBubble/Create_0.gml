...
function shouldFadeBubble(){
	return shouldFade(obj_player,obj_alert,obj_pointer_vari,obj_pointer,obj_pointer_menu,obj_rightHand, obj_cookFoodHand, obj_thermometer, obj_dragAndDrop_item_vari, obj_soap)
}
